...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class DestroyerFPS : MonoBehaviour
    {
        ...
        {
            // Read input
            float horizontal = CrossPlatformInputManager.GetAxis("LeftJoyX2");
            float vertical = CrossPlatformInputManager.GetAxis("LeftJoyY2");
