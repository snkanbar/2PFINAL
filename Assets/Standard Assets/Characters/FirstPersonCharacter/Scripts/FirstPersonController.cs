...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public string _joyLX = "LeftJoyX";
        public string _joyLY = "LeftJoyY";
        public string _joyRX = "RightJoyX";
        public string _joyRY = "RightJoyY";
        ...
        private void Update()
        {
            ...
            if (!m_Jump)
            {
                m_Jump = CrossPlatformInputManager.GetButtonDown(_jump);
            }
        ...
        {
            // Read input
            float horizontal = CrossPlatformInputManager.GetAxis(_joyLX);
            float vertical = CrossPlatformInputManager.GetAxis(_joyLY);
        ...
        {
            m_MouseLook.LookRotation (transform, m_Camera.transform, _joyRX, _joyRY);
        }
